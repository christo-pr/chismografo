  ...
  return (
    <div className="text-sm -mt-4">
      <Form onSubmit={onSubmit} error={props.error}>
        ...
        <TextField
          name="query"
          defaultValue={props.question?.query}
          className={CSS.input}
          errorClassName={CSS.inputError}
          validation={{ required: true }}
        />
        <FieldError name="query" className={CSS.errorMessage} />
        ...
        <TextField
          name="book"
          defaultValue={props.question?.book}
          className={CSS.input}
          errorClassName={CSS.inputError}
          validation={{ required: true }}
        />
        <FieldError name="book" className={CSS.errorMessage} />
        ...
        <TextField
          name="answers"
          defaultValue={props.question?.answers}
          className={CSS.input}
          errorClassName={CSS.inputError}
          validation={{ required: true }}
        />
        <FieldError name="answers" className={CSS.errorMessage} />
