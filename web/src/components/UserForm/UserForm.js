    ...
    <div className="text-sm -mt-4">
      <Form onSubmit={onSubmit} error={props.error}>
        ...
        <TextField
          ...
          validation={{ required: true }}
        />
        <FieldError name="password" className={CSS.errorMessage} />
        ...
        <TextField
          name="books"
          defaultValue={props.user?.books}
          className={CSS.input}
          errorClassName={CSS.inputError}
          validation={{ required: true }}
        />
        <FieldError name="books" className={CSS.errorMessage} />
        ...
        <TextField
          name="answers"
          defaultValue={props.user?.answers}
          className={CSS.input}
          errorClassName={CSS.inputError}
          validation={{ required: true }}
        />
