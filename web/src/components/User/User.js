      ...
      <div className="bg-white border rounded-lg overflow-hidden">
        ...
        <table className="w-full text-sm">
          <tbody>
            ...
            <tr className="odd:bg-gray-100 even:bg-white border-t">
              <td className="font-semibold p-3 text-right md:w-1/5">books</td>
              <td className="p-3">{user.books}</td>
            </tr>
            <tr className="odd:bg-gray-100 even:bg-white border-t">
            ...
            <tr className="odd:bg-gray-100 even:bg-white border-t">
              <td className="font-semibold p-3 text-right md:w-1/5">answers</td>
              <td className="p-3">{user.answers}</td>
            </tr>
