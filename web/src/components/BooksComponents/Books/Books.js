      ...
      <table className="table-auto w-full min-w-3xl text-sm">
        <thead>
          <tr className="bg-gray-300 text-gray-700">
            ...
            <th className="font-semibold text-left p-3">owner</th>
            {/* <th className="font-semibold text-left p-3">questions</th> */}
        ...
        <tbody>
          {books.map((book) => (
            ...
            >
              ...
              <td className="p-3">{truncate(book.code)}</td>
              <td className="p-3">{truncate(book.owner)}</td>
              {/* <td className="p-3">{truncate(book.questions)}</td> */}
              <td className="p-3">{timeTag(book.createdAt)}</td>
              <td className="p-3">{timeTag(book.updatedAt)}</td>
